...
void AFPSAIGuard::OnNoiseHeard(APawn * NoiseInstigator, const FVector & Location, float Volume)
{
	...
	GetWorldTimerManager().SetTimer(TimerHandle_LifeSpanExpired, this, &AFPSAIGuard::ResetOrientation, 3.0f);
...
{
	if (GuardState == NewState) // if state hasn't changed do nothing
	{
		return;
	}
